...
| Dungeon instance pertama (The Sunken Crypt) | ✅ | `DungeonService.lua` + `DungeonController.lua` + UI (lobby L-key, status panel, rewards popup). 3 dungeon. Wave+boss+rewards. Tested 145/145. |
